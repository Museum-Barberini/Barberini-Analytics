...
class GTrendsTopicsJson(luigi.Task):
    ...
    def output(self):
        return luigi.LocalTarget('output/google-trends/topics.json', format=UTF8)
    ...
    def collect_topics(self):
        with open(self.input_file, encoding='utf-8') as json_top_10_facts_about_barberini_you_didnt_know_number_8_will_shock_you:
            barberini_facts = json.load(json_top_10_facts_about_barberini_you_didnt_know_number_8_will_shock_you)
