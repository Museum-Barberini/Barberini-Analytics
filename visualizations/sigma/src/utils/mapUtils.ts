interface Map<K, V> {
	/**
	 * Returns the value associated with a key in this map. If no value is associated, add an association with a default value.
	 * This is a direct equivalent of good old Smalltalk's #at:ifAbsentPut:.
	 * @param funDefault The default value. If it is a parameterless function, it will be called, otherwise, it will be stored directly.
	 */
