...
BEGIN;
    ...
    ALTER TABLE appstore_review
        ...
        PRIMARY KEY     (appstore_review_id);
    ...
    ALTER TABLE exhibition
        ADD CONSTRAINT  exhibition_primkey
    ...
    ALTER TABLE fb_post
        ADD CONSTRAINT  fb_post_primkey
    ...
    ALTER TABLE fb_post_performance
        ADD CONSTRAINT  fb_post_performance_primkey
        PRIMARY KEY     (fb_post_id, time_stamp);
    -- Added post hoc as part of extraction of foreign keys from the code
    ALTER TABLE fb_post_performance
        ADD CONSTRAINT  fb_post_id_fkey
        FOREIGN KEY     (fb_post_id)
        REFERENCES      fb_post (fb_post_id);
    ...
    ALTER TABLE gomus_booking
        ADD CONSTRAINT  gomus_booking_primkey
    ...
    ALTER TABLE gomus_customer
        ADD CONSTRAINT  gomus_customer_primkey
    ...
    ALTER TABLE gomus_daily_entry
        ADD CONSTRAINT  gomus_daily_entry_primkey
    ...
    ALTER TABLE gomus_event
        ADD CONSTRAINT  gomus_event_primkey
    ...
    ALTER TABLE gomus_expected_daily_entry
        ADD CONSTRAINT  gomus_expected_daily_entry_primkey
        PRIMARY KEY     (id, datetime);
    ...
    ALTER TABLE gomus_order
        ADD CONSTRAINT  gomus_order_primkey
    ...
    ALTER TABLE gomus_order_contains
        ADD CONSTRAINT gomus_order_contains_primkey
    ...
    ALTER TABLE gomus_to_customer_mapping
        ADD CONSTRAINT  gomus_to_customer_mapping_primkey
        PRIMARY KEY     (gomus_id);
    ...
    ALTER TABLE gomus_event
        ...
        REFERENCES      gomus_booking (booking_id);
    ALTER TABLE gomus_order
        ADD CONSTRAINT  customer_id_fkey
        FOREIGN KEY     (customer_id)
        REFERENCES      gomus_customer (customer_id);
    ALTER TABLE gomus_order_contains
        ADD CONSTRAINT  order_id_fkey
        FOREIGN KEY (order_id)
        REFERENCES  gomus_order (order_id);
    -- Added post hoc as part of extraction of foreign keys from the code
    ALTER TABLE gomus_to_customer_mapping
        ADD CONSTRAINT  customer_id_fkey
        FOREIGN KEY     (customer_id)
    ...
    ALTER TABLE google_maps_review
        ADD CONSTRAINT  google_maps_review_primkey
        PRIMARY KEY     (google_maps_review_id);
    ...
    ALTER TABLE gplay_review
        ...
        PRIMARY KEY     (playstore_review_id);
    ...
    ALTER TABLE gtrends_value
        ADD CONSTRAINT  gtrends_value_primkey
    ...
    ALTER TABLE tweet_performance
        ADD CONSTRAINT  tweet_performance_primkey
        PRIMARY KEY     (tweet_id, timestamp);
    ALTER TABLE tweet_performance
        ADD CONSTRAINT  tweet_id_fkey
